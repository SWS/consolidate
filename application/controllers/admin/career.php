...
$data['addscripts'] = 'career_add_job';
    ...
    function edit_job_section($id = false) {
        ...
        $data['product_name'] = 'Job Section';
        $data['id'] = $id;
$data['addscripts'] = 'career_edit_job';
    ...
    function question($id = false) {
        ...
        $data['title'] = 'Welcome To CompanyName';
        $data['active'] = 'job';
        $data['addscripts'] = 'career_question_list';
    ...
    function user_block() {
        ...
        $data['active'] = 'interview';
        $data['label'] = 'block';
        $data['addscripts'] = 'career_interview_list';
    ...
    function job_section() {
        ...
        $data['title'] = 'Welcome To CompanyName';
        $data['active'] = 'interview';
        $data['addscripts'] = 'career_job_list';
