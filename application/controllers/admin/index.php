...
class Index extends CI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->load->model(array('admin_model', 'comman_model', 'block_list_email'));
    ...
    function login() {
        ...
        $this->form_validation->set_rules('password', 'Password', 'required|xss_clean|callback__check_database');
    ...
    function send_mail() {
        ...
        if ($this->input->post('operation')) {
            ...
            $this->email->from('admin@kondarglobal.ca', $title);
    ...
    function welcome_page() {
        ...
        $data['login'] = $this->session->all_userdata();
        $data['active'] = 'welcome';
        $data['addscripts'] = 'welcome_page_list';
        $data['all_data'] = $this->comman_model->all_data('home_page');
        $this->load->view('admin/header', $data);
        $this->load->view('admin/left_menu', $data);
    ...
    function user_block() {
        ...
        $data['label'] = 'block';
        $data['addscripts'] = 'interview_list';
    ...
    function library_product() {
        ...
        $data['title'] = 'Welcome To CompanyName';
        $data['active'] = 'home';
        $data['addscripts'] = 'library_product_list';
$data['all_data'] = $this->comman_model->all_data('product_image');
        $this->load->view('admin/header', $data);
        $this->load->view('admin/left_menu', $data);
    ...
    function contact_user_block() {
        ...
        $data['addscripts'] = 'contact_user_list';
    ...
    function promotion_category() {
        ...
        $data['title'] = 'Welcome To CompanyName';
        $data['active'] = 'promotion_section';
        $data['addscripts'] = 'promotion_category_list';
    ...
    function knowledge_subtitle() {
        ...
        $data['title'] = 'Welcome To CompanyName';
        $data['active'] = 'promotion_section';
        $data['addscripts'] = 'knowledge_sub_list';
    ...
    function edit_knowledge_subtitle($id = false) {
        ...
        $data['title'] = 'Welcome To CompanyName';
        $data['active'] = 'promotion_section';
        $data['addscripts'] = 'edit_knowledge_subtitle';
    ...
    function promotion_section() {
        ...
        $data['title'] = 'Welcome To CompanyName';
        $data['active'] = 'promotion_section';
        $data['addscripts'] = 'promotion_list';
    ...
    function edit_promotion_section($id = false) {
        ...
        $data['title'] = 'Welcome To CompanyName';
        $data['active'] = 'promotion_section';
        $data['addscripts'] = 'edit_promotion';
    ...
    function promotion_block_user() {
        ...
        $data['active'] = 'promotion_section';
        $data['label'] = 'Block User List';
        $data['addscripts'] = 'promotion_user_list';
...
$data['addscripts'] = 'edit_menu';
    ...
    function career_message() {
        ...
        if ($this->input->post('operation')) {
            ...
            $update_data['modal_success_header'] = $this->input->post("modal_success_header");
            $update_data['modal_success_body'] = $this->input->post("modal_success_body");
            $update_data['already_applied'] = $this->input->post("already_applied");
            $update_data['warning_qus1_min_chr'] = $this->input->post("warning_qus1_min_chr");
            $update_data['thank_you_for_answering'] = $this->input->post("thank_you_for_answering");
            $update_data['resume_upload_warning'] = $this->input->post("resume_upload_warning");
