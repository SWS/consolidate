...
class Cart extends CI_Controller {
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->load->model(array('serial_model', 'product_model', 'menu_model', 'country_model', 'comman_model', 'cart_model'));
        $this->load->helper(array('assets', 'av_helper', 'cart_helper'));
        $this->load->language(array('header', 'cart', 'footer'));
    }
    ...
    function cart_mail($email, $cart_users_data, $cart_details, $fromemailid, $name = "") {
        ...
        $orderdetails = '<table width="100%" border="1px">
							<tr><td class="red1">No</td><td class="red1">KGT Number</td><td class="red1">Quantity</td><td class="red1">Comment</td></tr>';
        $i = 1;
        foreach ($cart_details as $cart) {
