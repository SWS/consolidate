...
class Distribution extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('product_model', 'menu_model', 'comman_model', 'country_model', 'common_model'));
    ...
    function index($page = false, $arg1 = "", $arg2 = "", $arg3 = "", $arg4 = "", $arg5 = "") {
        ...
        if ($page == 'do_upload') {
            ...
            $data['license_picture_path'] = $this->_get_license_name(true, false, isset($res['upload_data']["file_name"]) ? $res['upload_data']["file_name"] : "");

            $data['license_picture_name'] = $this->_get_license_name(false, true, isset($res['upload_data']["file_name"]) ? $res['upload_data']["file_name"] : "");
            ...
            $res['license_picture_path'] = $this->_get_license_name(true, false, "");

            $res['license_picture_name'] = $this->_get_license_name(false, true, "");
            ...
            switch ($res['int_verification_result']) {
                ...
                case 1: $res['str_verification_message'] = '';
                    $res['end'] = 'first';
                    break;
...
//
            ...
            $data['license_picture_path'] = $this->_get_license_name(true, false, "");

            $data['license_picture_name'] = $this->_get_license_name(false, true, "");
    ...
    private function _get_license_name($bln_path, $bln_real, $file_name) {
    ...
    function do_upload() {
        ...
        if (isset($_FILES['license']['name']) && $_FILES['license']['name'] != '') {
            ...
            if (!$this->upload->do_upload("license")) {
                ...
                $data['upload_error'] = $this->upload->display_errors("<span class='colorred4'>", "</span>");
            } else {
    ...
    function do_block($str_email, $int_case = 1, $str_applicant = "", $str_country = "", $str_telephone = "") {
        ...
        $db_res = $this->common_model->getDistAppSupportByEmail(strtolower($str_email));
    ...
    function do_send_email() {
        ...
        //edited to execute the operation for the block_email_list table
        $this->load->model("block_list_email");
        $where_param = array();
