                                    ...
                                    <div class="block well">
                                        <div class="navbar">
                                            <div class="navbar-inner">
                                                <h5> <?php echo lang('Add') . ' ' . $product_name; ?></h5></div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name="category" required>
                                                    ...
                                                    <option
                                                        value="Permanent Job"><?php echo lang('Permanent Job') ?></option>
                                                    <option
                                                        value="Internship Program"><?php echo lang('Internship Program') ?></option>
                                                    <option
                                                        value="Part Time Job"><?php echo lang('Part Time Job') ?></option>
                                                    <option
                                                        value="Projects Contractors"><?php echo lang('Projects Contractors') ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <input type="file" class ="floatleft2" name="file"/>
                                            </div>
                                            ...
                                            <div class="divjobimage">
                                                ...
                                                <div class ="floatleft1">
                                                    ...
                                                    <br>
                                                    <a class="job_delete_image hide" href="#"
                                            ...
                                            <div class="clear-fix1">
                                                ...
                                                <p class="red1"><?php echo lang('Please file must be : jpg, png, gif. maximum 800KB and maximum 1024X768') ?></p>
...
<div class="onequstiontemplate hide">
    ...
    <span class="removeques" id="kgt10"><?php echo lang('Remove'); ?></span>
</div>
</div>
