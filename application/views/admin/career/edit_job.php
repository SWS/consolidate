        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <div class="block well">
                    <div class="navbar">
                        <div class="navbar-inner"><h5> <?php echo lang('Edit Job Section') ?></h5></div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls" id="scope">
                            <textarea id="content" class="ckeditor"
                                      name="scope"><?php echo $edit_data['scope']; ?></textarea>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls" id="qualification">
                            <textarea id="content1" class="ckeditor"
                                      name="qualification"><?php echo $edit_data['qualification']; ?></textarea>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls" class ="floatleft2">
                            ...
                            <?php if (isset($edit_data['image']) && !empty($edit_data['image'])) : ?>
                                <div class ="floatleft1"><img
                                    ...
                                    <a class="job_delete_image"
                                       href="admin/career/delete_job_image/<?php echo $edit_data['id'] ?>"
                                       onclick="return confirm_box();"><?php echo lang('Delete') ?></a></div>
                            <?php
                            else:
                                ?>
                        ...
                        foreach ($questions as $question) :
                            ...
                            <div class="onequstion_<?php echo $question['id']; ?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="title2" name="question[]" class="focustip span10" type="text"
                                               value="<?php echo $question['name'] ?>" required="">
                                    </div>
                                    <br>
                                ...
                                <span class="removeques" id="kgt10"
                                      onClick="delete_question(<?php echo $question['id']; ?>)"><?php echo lang('Remove') ?></span>
