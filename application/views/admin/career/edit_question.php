    ...
    <div class="outer">
        <div class="inner">
            <div class="page-header">
                <!-- page title -->
                <h5><i class="font-user"></i><?php echo lang('Globe'); ?></h5>
                <!-- End page title -->
                <div class="body">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="block well">
                                            <div class="navbar">
                                                <div class="navbar-inner"><h5> <?php echo lang('Edit Globe'); ?></h5>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="min_word"
                                                           value="<?php echo $edit_data['min_words'] ?>">
                                                </div>
                                            </div>

                                            <div class="form-actions align-right">
                                                <input class="btn btn-primary" value="<?php echo lang('Add'); ?>"
                                                       id="send" type="submit">
