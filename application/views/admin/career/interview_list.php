    ...
    <div class="navbar-inner">
        ...
        <div class="pull-right">
            ...
            <?php if (isset($all_data)) { ?>
                <button id="delete_checked_interview" class="deletebtn">Delete
                    All
                </button>
        ...
        <tr class="odd row_<?php echo $set_data['id']; ?>">
            ...
            <td class="dataTables" valign="top">
                <input class="blocks" type="checkbox" name="delete_option[]" value="<?php echo $set_data['id']; ?>"
                       data-jobid="<?php echo $set_data['job_id']; ?>">
            </td>
            ...
            <td class="dataTables" valign="top">
                ...
                <a href="admin/career/delete_interview_section/<?php echo $set_data['id']; ?>/<?php echo $set_data['job_id']; ?>"
    ...
    if ($set_data['block'] == 1) {
        ...
        <tr class="odd">
            ...
            <td class="dataTables" valign="top">
                ...
                <a href="admin/career/delete_user_block/<?php echo $set_data['id']; ?>"
                   onclick="return confirm_box();"><?php echo lang('Delete'); ?></a>
