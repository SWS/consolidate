                                        ...
                                        <label>
                                            <div id="" class="selector">
                                                <a class="floatright" tabindex="0"
                                                   id="data-table_first" href="admin/career/add_job_section">
                                                    <?php echo lang('Add') ?></a>
                                            </div>
                                    ...
                                    <table aria-describedby="data-table_info" class="table table-striped dataTable"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th colspan="1" rowspan="1"
                                                width="120"><?php echo lang('Number Of Question'); ?></th>
                                            ...
                                            foreach ($all_data as $set_data) {
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        ...
                                                        <a href="admin/career/delete_job_section/<?php echo $set_data['id']; ?>"
