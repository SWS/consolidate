                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span12">
                                    ...
                                    <div class="block well">
                                        <div class="navbar">
                                            <div class="navbar-inner"><h5>Main Contact Timer</h5></div>
                                        </div>
                                        ...
                                        <div class="displaynon control-group">
                                            ...
                                            <div class="controls"><input id="title2" name="main_contact_msg"
                                                                         class="focustip span12" type="text"
                                                                         value="<?php echo $contact_timer[0]->main_contact_msg; ?>">
                                            </div>
                                    ...
                                    <div class="block well">
                                        <div class="navbar">
                                            <div class="navbar-inner"><h5>Contact Preview Timer</h5></div>
                                        </div>
                                        ...
                                        <div class="displaynon control-group">
                                            ...
                                            <div class="controls"><input id="title2" name="contact_preview_msg"
                                                                         class="focustip span12" type="text"
                                                                         value="<?php if (isset($contact_timer[0]->contact_preview_msg)) echo $contact_timer[0]->contact_preview_msg; ?>">
                                            </div>
                                            <span class="red1"><?php echo form_error('new_password'); ?></span>
                                        </div>
                                    ...
                                    <div class="block well">
                                        <div class="navbar">
                                            <div class="navbar-inner"><h5>Contact verification code popup Timer</h5>
                                            </div>
                                        </div>
                                        ...
                                        <div class="displaynon control-group">
                                            ...
                                            <div class="controls"><input id="title2" name="contact_popup_msg"
                                                                         class="focustip span12" type="text"
                                                                         value="<?php if (isset($contact_timer[0]->contact_popup_msg)) echo $contact_timer[0]->contact_popup_msg; ?>">
                                            </div>
                                            <span class="red1"><?php echo form_error('new_password'); ?></span>
                                        </div>
                                    </div>
                                    <div class="block well">
                                        <div class="navbar">
                                            <div class="navbar-inner"><h5>Edit Contact Timer</h5></div>
                                        </div>
                                        ...
                                        <div class="displaynon control-group">
                                            ...
                                            <div class="controls"><input id="title2" name="contact_edit_msg"
                                                                         class="focustip span12" type="text"
                                                                         value="<?php if (isset($contact_timer[0]->contact_edit_msg)) echo $contact_timer[0]->contact_edit_msg; ?>">
                                            </div>
                                            <span class="red1"><?php echo form_error('new_password'); ?></span>
                                        </div>
                                    </div>
