                ...
                <table aria-describedby="data-table_info" class="table table-striped dataTable" id="data-table">
                    ...
                    <tr role="row">
                        ...
                        <th colspan="1" rowspan="1"
                            width="100"><?php echo $this->lang->line('') . 'Designation'; ?></th>
                    ...
                    foreach ($all_data as $set_data) {
                        if ($set_data['block'] == 0) {
                            ...
                            <tr class="odd">
                                ...
                                <td class="dataTables" valign="top">
                                    <a href="admin/index/delete/contact_user/<?php echo $set_data['id']; ?>"
                    ...
                    foreach ($all_data1 as $set_data) {
                        if ($set_data['block'] == 1) {
                            ...
                            <tr class="odd">
                                ...
                                <td class="dataTables" valign="top">
                                    <a href="admin/index/delete/contact_user_block/<?php echo $set_data['id']; ?>"
                                       onclick="return confirm_box();">Delete</a>
                                </td>
                            </tr>
                        <?php
