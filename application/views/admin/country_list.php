                                    ...
                                    <div class="dataTables_length" id="data-table_length">
                                        <label>
                                            <div id="" class="selector">
                                                <a class="marginright10px floatright1" tabindex="0"
                                                   id="data-table_first" href="admin/index/add_language">
                                                    <?php echo $this->lang->line('add'); ?>
                                                </a>
                                            </div>
                                            <button id="delete_checked" class="deletebtn2">
                                                Delete All
                                            </button>
                                        </label>
                                    </div>
                                        ...
                                        if (isset($all_data)) {
                                            foreach ($all_data as $set_data) {
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        <select
                                                            onchange="user_status('country',<?php echo $set_data['id']; ?>,this.value)"
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        <a href="admin/index/edit_language/<?php echo $set_data['id']; ?>">Edit</a>&nbsp;&nbsp;
                                                        <a href="admin/index/delete/language/<?php echo $set_data['id']; ?>"
                                ...
                                if ($('input.blocks:checkbox:checked').length) {
                                    ...
                                    if (answer) {
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            url: url,
                                            data: {'block_ids': blocksarray, 'table': 'country', 'have_image': true, 'path': 'country'},
