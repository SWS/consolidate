                                ...
                                <div id="data-table_wrapper" class="dataTables_wrapper" role="grid">
                                    <table aria-describedby="data-table_info" class="table table-striped dataTable"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th colspan="1"
                                                rowspan="1"><?php echo $this->lang->line('designation'); ?></th>
                                            ...
                                            <th colspan="1"
                                                rowspan="1"><?php echo $this->lang->line('companysize'); ?></th>
                                            <th colspan="1"
                                                rowspan="1"><?php echo $this->lang->line('companystart'); ?></th>
                                            <th colspan="1"
                                                rowspan="1"><?php echo $this->lang->line('indoor_sales'); ?></th>
                                            <th colspan="1"
                                                rowspan="1"><?php echo $this->lang->line('outdoor_sales'); ?></th>
                                            <th colspan="1"
                                                rowspan="1"><?php echo $this->lang->line('sales_brief'); ?></th>
                                        ...
                                        if (isset($all_data)) {
                                            ...
                                            foreach ($all_data as $set_data) {
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        <a href="admin/distribution/delete_distribution/<?php echo $set_data['id']; ?>"
