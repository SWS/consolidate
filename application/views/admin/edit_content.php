            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <div class="block well">
                        ...
                        <div class="navbar">
                            <div class="navbar-inner"><h5> <?php echo $this->lang->line('') . 'Edit About'; ?></h5>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls"><input id="title2" name="title" class="focustip span12" type="text"
                                                         value="<?php echo $edit_data['title']; ?>"></div>
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <div class="block well">
                        ...
                        <div class="navbar">
                            <div class="navbar-inner"><h5> <?php echo $this->lang->line('') . 'Edit Vision'; ?></h5>
                            </div>
                        </div>
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <div class="block well">
                        ...
                        <div class="navbar">
                            <div class="navbar-inner"><h5> <?php echo $this->lang->line('') . 'Edit Mission'; ?></h5>
                            </div>
                        </div>
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <div class="block well">
                        ...
                        <div class="navbar">
                            <div class="navbar-inner"><h5> <?php echo $this->lang->line('') . 'Edit Career'; ?></h5>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls"><textarea id="content" name="description" class="focustip span12"
                                                            rows="10"><?php echo $edit_data['description']; ?></textarea>
