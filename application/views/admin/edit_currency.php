                                        ...
                                        <div class="block well">
                                            <div class="navbar">
                                                <div class="navbar-inner"><h5>
                                                        Edit <?php echo $this->lang->line('currency'); ?></h5></div>
                                            </div>
                                            <div class="control-group">
                                                ...
                                                <div class="controls"><input id="title2" name="title"
                                                                             ...
                                                                             value="<?php echo $currency_data['name']; ?>">
                                                </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls"><input id="title2" name="address"
                                                                             class="focustip span12" type="text"
                                                                             value="<?php echo $currency_data['address']; ?>">
                                                </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls"><input type="text" id="content" name="buy_price"
                                                                             class="focustip span12"
                                                                             value="<?php echo $currency_data['buy_price']; ?>">
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label">Sell Price ($):</label>

                                                <div class="controls"><input type="text" id="content" name="sell_price"
                                                                             class="focustip span12"
                                                                             value="<?php echo $currency_data['sell_price']; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls"><textarea id="content" name="description"
                                                                                class="focustip span12"
                                                                                rows="10"><?php echo $currency_data['description']; ?></textarea>
                                                </div>
                                            </div>
