        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <div class="block well">
                    <div class="navbar">
                        <div class="navbar-inner"><h5> <?php echo $this->lang->line('') . 'Time Position'; ?></h5></div>
                    </div>
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <div class="block well">
                    <div class="navbar">
                        <div class="navbar-inner"><h5> <?php echo $this->lang->line('') . 'Globe Position'; ?></h5>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Position:</label>
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <div class="block well">
                    <div class="navbar">
                        <div class="navbar-inner"><h5> <?php echo $this->lang->line('') . 'Product Position'; ?></h5>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Position:</label>
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <div class="block well">
                    <div class="navbar">
                        <div class="navbar-inner"><h5> <?php echo $this->lang->line('') . 'Globe Size'; ?></h5></div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Position:</label>
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <div class="block well">
                    <div class="navbar">
                        <div class="navbar-inner"><h5> <?php echo $this->lang->line('') . 'Background'; ?></h5></div>
                    </div>
                    <div class="control-group">
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <div class="block well">
                    <div class="navbar">
                        <div class="navbar-inner"><h5> <?php echo $this->lang->line('') . 'Library Background'; ?></h5>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Photo:</label>
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <div class="block well">
                    <div class="navbar">
                        <div class="navbar-inner"><h5> <?php echo $this->lang->line('') . 'Globe'; ?></h5></div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Photo:</label>
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <div class="block well">
                    <div class="navbar">
                        <div class="navbar-inner"><h5> <?php echo $this->lang->line('') . 'Logo'; ?></h5></div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Name:</label>

                        <div class="controls"><input id="title2" name="title" class="focustip span12" type="text"
                                                     value="<?php echo $edit_data['name']; ?>"></div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls"><input type="file" name="file"/></div>
                        <span class="red1"><?php echo 'Attech image with 450X133 resolution' ?></span>
                    </div>
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <div class="block well">
                    <div class="navbar">
                        <div class="navbar-inner"><h5> <?php echo $this->lang->line('') . 'Footer'; ?></h5></div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Name:</label>

                        <div class="controls"><input id="title2" name="title" class="focustip span12" type="text"
                                                     value="<?php echo $edit_data['footer_name']; ?>"></div>
                        <span class="red1"><?php echo form_error('title'); ?></span>
                    </div>
                    <div class="form-actions align-right">
                        <input class="btn btn-primary" value="Update" id="send" type="submit">
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <div class="block well">
                    <div class="navbar">
                        <div class="navbar-inner"><h5> <?php echo $this->lang->line('') . 'Admin Mail ID'; ?></h5></div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Mail ID:</label>

                        <div class="controls"><input id="title2" name="title" class="focustip span12" type="text"
                                                     value="<?php echo $edit_data['admin_mail']; ?>"></div>
                        <span class="red1"><?php echo form_error('title'); ?></span>
                    </div>
                    <div class="form-actions align-right">
                        <input class="btn btn-primary" value="Update" id="send" type="submit">
            ...
            <div class="span12">
                ...
                <div class="block well">
                    ...
                    <div class="control-group">
                        ...
                        <span class="red1"><?php echo 'Attech image with 760X190 resolution' ?></span>
                    </div>
