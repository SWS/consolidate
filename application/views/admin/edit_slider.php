                                        ...
                                        <div class="block well">
                                            <div class="navbar">
                                                <div class="navbar-inner">
                                                    <h5> <?php echo $this->lang->line('') . 'Edit Slider'; ?></h5></div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls"><input id="alt" name="alt" class="focustip span12"
                                                                             type="text"
                                                                             value="<?php echo $edit_data['alt']; ?>">
                                                </div>
                                                <span class="red1"><?php echo form_error('title'); ?></span>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls"><input id="link" name="link"
                                                                             class="focustip span12" type="text"
                                                                             value="<?php echo $edit_data['link']; ?>">
                                                </div>
                                                <span class="red1"><?php echo form_error('title'); ?></span>
                                            </div>
