                                        ...
                                        <label>
                                            <div id="" class="selector">
                                                <a class="floatright" tabindex="0"
                                                   id="data-table_first" href="admin/index/add_globe">
                                            ...
                                            foreach ($all_data as $set_data) {
                                                if ($set_data['set_image'] == 'welcome') {
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td class="dataTables" valign="top">
                                                            <a href="admin/index/edit_globe/<?php echo $set_data['id']; ?>">Edit</a>&nbsp;&nbsp;
                                                            <a href="admin/index/delete/globe_product/<?php echo $set_data['id']; ?>"
