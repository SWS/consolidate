...
?>
            ...
            <td><a href="admin/index/edit_welcome_page/globe_position/<?php echo $set_data['id']; ?>">Edit</a>&nbsp;&nbsp;
            </td>
        </tr>
...
?>
            ...
            <td><a href="admin/index/edit_welcome_page/product_position/<?php echo $set_data['id']; ?>">Edit</a>&nbsp;&nbsp;
            </td>
        </tr>
