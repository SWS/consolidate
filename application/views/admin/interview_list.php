                                    ...
                                    <table aria-describedby="data-table_info" class="table table-striped dataTable"
                                        ...
                                        <tr role="row">
                                            <th colspan="1" rowspan="1"
                                                width="100"><?php echo $this->lang->line('') . 'Name'; ?></th>
                                            <th colspan="1" rowspan="1"
                                                width="100"><?php echo $this->lang->line('') . 'Email'; ?></th>
                                            <th colspan="1" rowspan="1"
                                                width="100"><?php echo $this->lang->line('') . 'Contact'; ?></th>
                                            <th colspan="1" rowspan="1"
                                                width="100"><?php echo $this->lang->line('') . 'Country'; ?></th>
                                            <th colspan="1" rowspan="1"
                                                width="100"><?php echo $this->lang->line('') . 'Job Section'; ?></th>
                                            <th colspan="1" rowspan="1"
                                                width="150"><?php echo $this->lang->line('') . 'Views'; ?></th>
                                            <th colspan="1" rowspan="1"
                                                width="150"><?php echo $this->lang->line('') . 'Document'; ?></th>
                                            <th colspan="1" rowspan="1"
                                                width="150"><?php echo $this->lang->line('') . 'Confirm'; ?></th>
                                            <th colspan="1" rowspan="1"
                                                width="150"><?php echo $this->lang->line('') . 'Option'; ?></th>
                                        </tr>
                                        </thead>
                                        ...
                                        foreach ($all_data as $set_data) {
                                            if ($set_data['block'] == 0) {
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        <a href="admin/index/delete/interview_section/<?php echo $set_data['id']; ?>"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th colspan="1" rowspan="1"
                                                width="100"><?php echo $this->lang->line('') . 'Job Section'; ?></th>
                                            <th colspan="1" rowspan="1"
                                                width="150"><?php echo $this->lang->line('') . 'Block'; ?></th>
                                            <th colspan="1" rowspan="1"
                                                width="150"><?php echo $this->lang->line('') . 'Option'; ?></th>
                                        </tr>
                                        </thead>
                                        ...
                                        foreach ($all_data1 as $set_data) {
                                            if ($set_data['block'] == 1) {
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        <a href="admin/index/delete/user_block/<?php echo $set_data['id']; ?>"
                                                           onclick="return confirm_box();">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php
