                                        ...
                                        <label>
                                            <div id="" class="selector">
                                                <a class="floatright" tabindex="0"
                                                   id="data-table_first" href="admin/index/add_job_section">
                                ...
                                <div id="data-table_wrapper" class="dataTables_wrapper" role="grid">
                                    <table aria-describedby="data-table_info" class="table table-striped dataTable"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th colspan="1"
                                                rowspan="1"><?php echo $this->lang->line('') . 'Category'; ?></th>
                                            <th colspan="1" rowspan="1"
                                                width="120"><?php echo $this->lang->line('') . 'Number Of Question'; ?></th>
                                            <th colspan="1" rowspan="1"
                                                width="40"><?php echo $this->lang->line('status'); ?></th>
                                            <th colspan="1" rowspan="1"
                                                width="90"><?php echo $this->lang->line('option'); ?></th>
                                        </tr>
                                        </thead>
                                            ...
                                            foreach ($all_data as $set_data) {
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        ...
                                                        if (!empty($question)) {
                                                            ?>
                                                            <a href="admin/index/question/<?php echo $set_data['id']; ?>"><?php echo count($question); ?></a>
                                                        <?php
                                                        } else {
                                                            echo 'No Question';
                                                        }
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        <select
                                                            onchange="user_status('job_section',<?php echo $set_data['id']; ?>,this.value)"
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        <a href="admin/index/edit_job_section/<?php echo $set_data['id']; ?>">Edit</a>&nbsp;&nbsp;
                                                        <a href="admin/index/delete/job_section/<?php echo $set_data['id']; ?>"
