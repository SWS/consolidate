    ...
    <div class="outer">
        <div class="inner">
            <div class="page-header">
                <!-- page title -->
                <h5><i class="font-user"></i><?php echo $this->lang->line('') . 'Knowledge Sub Title'; ?></h5>
                <!-- End page title -->
                <div class="body">
                                        ...
                                        <label>
                                            <div id="" class="selector">
                                                <a class="floatright" tabindex="0"
                                                   id="data-table_first" href="admin/index/add_knowledge_subtitle">
                                ...
                                <div id="data-table_wrapper" class="dataTables_wrapper" role="grid">
                                    <table aria-describedby="data-table_info" class="table table-striped dataTable"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th colspan="1" rowspan="1"
                                                width="120"><?php echo $this->lang->line('') . 'Knowledge Category'; ?></th>
                                            <th colspan="1"
                                        ...
                                        if (isset($all_data)) {
                                            foreach ($all_data as $set_data) {
                                                $promotion = $this->comman_model->get_data_by_id('promotion_section', array('id' => $set_data['parent_id']));
                                                ?>
                                                <tr class="odd">
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        <a href="admin/index/edit_knowledge_subtitle/<?php echo $set_data['id']; ?>">Edit</a>&nbsp;&nbsp;
                                                        <a href="admin/index/delete/knowledge_subtitle/<?php echo $set_data['id']; ?>"
