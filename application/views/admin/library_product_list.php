    ...
    <div class="outer">
        <div class="inner">
            <div class="page-header">
                <!-- page title -->
                <h5><i class="font-user"></i><?php echo $this->lang->line('') . 'Library Product'; ?></h5>
                <!-- End page title -->
                <div class="body">
                                        ...
                                        <label>
                                            <div id="" class="selector">
                                                <a class="floatright" tabindex="0"
                                                   id="data-table_first" href="admin/index/add_library">
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td class="dataTables" valign="top">
                                                            ...
                                                            if (isset($set_data['image']) && $set_data['image'] != '') {
                                                                $logo = 'assets/uploads/globe_product/thumbnails/' . $set_data['image'];
                                                            } else {
                                                        ...
                                                        <td class="dataTables" valign="top">
                                                            <select
                                                                onchange="user_status('product_image',<?php echo $set_data['id']; ?>,this.value)"
                                                        ...
                                                        <td class="dataTables" valign="top">
                                                            <a href="admin/index/edit_library/<?php echo $set_data['id']; ?>">Edit</a>&nbsp;&nbsp;
                                                            <a href="admin/index/delete/library_product/<?php echo $set_data['id']; ?>"
