        ...
        <div class="well">
            ...
            <form action="" method="POST" class="row-fluid">
                ...
                <div class="control-group">
                    ...
                    <div class="controls"><input class="span12" type="text" name="username" placeholder="username"
                                                 autofocus/></div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls"><input class="span12" type="password" name="password" placeholder="password"/>
                    </div>
                    <?php echo form_error('password'); ?>
                </div>
                <div class="login-btn"><input type="submit" value="Login" name="login"
                                              class="btn btn-info btn-block btn-large"/></div>
            </form>
            <?php
