                            ...
                            <div class="navbar">
                                <div class="navbar-inner">
                                    ...
                                    <div class="control-group row-fluid width50_float_left">
                                        <form action="<?php echo base_url(); ?>admin/makers/index" method="post"
                                        ...
                                        <label>
                                            <div id="" class="selector">
                                                <a class="floatright" tabindex="0"
                                                   id="data-table_first" href="admin/makers/add_productmakers">ADD</a>
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div id="data-table_wrapper" class="dataTables_wrapper" role="grid">
                                    <table aria-describedby="data-table_info" class="table table-striped dataTable"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th><?php echo $this->lang->line('') . 'Vehicle Brand Logo'; ?></th>
                                        ...
                                        if (isset($all_data)) {
                                            foreach ($all_data as $set_data) {
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="dataTables" valign="top"><img
                                                            src="<?php echo './assets/uploads/product_maker/' . $set_data['maker_logo']; ?>"
                                                            width="100" />
                                                    </td>
                                                    <td class="dataTables" valign="top">
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        <a href="admin/makers/edit_maker/<?php echo $set_data['id']; ?>">Edit</a>&nbsp;&nbsp;
                                                        <a href="admin/makers/delete_maker/<?php echo $set_data['id']; ?>"
