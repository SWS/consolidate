...
<!-- End page title -->
<div class="body">
<form action="<?php echo base_url(); ?>admin/product/index" method="post" enctype="multipart/form-data"
...
<div class="navbar">
    <div class="navbar-inner">
        ...
        <div class="control-group row-fluid width50_float_left">
            ...
            <div class="controls"><input type="search" id="search" name="search" value="<?php echo $search; ?>"
        ...
        <div class="dataTables_length" id="data-table_length">
            <label>
                <div id="" class="selector">
                    <a class="floatright" tabindex="0" id="data-table_first"
                       href="admin/product/add_product">ADD</a>
                </div>
            </label>
        </div>
    </div>
...
<tr role="row">
    <th><input type="checkbox" id="checkall" class="checkall"
               onchange="$('.rowitemdelete').prop('checked',this.checked);"></th>
...
if (isset($all_data)) {
    foreach ($all_data as $set_data) {
        ...
        <tr class="odd mainrow">
            <th><input type="checkbox" id="checkitem" class="rowitemdelete" name="deleteitem[]"
                       value="<?php echo $set_data['id']; ?>"></th>
            <th><?php echo $i; ?></th>
                    ...
                    <div class="detail_wrap aligncenter">
                        <?php if (in_array("drawing_photo", $privilage)) { ?>
                            <?php if ($set_data['drawing_photo'] != '') { ?>
                                <img src="./assets/uploads/product_images/<?php echo $set_data['drawing_photo']; ?>"
                                     width="95" height="80"/>
                            <?php } else { ?>
                        ...
                        <?php if (in_array("product_photo", $privilage)) { ?>
                            <?php if ($set_data['product_photo'] != '') { ?>
                                <img src="./assets/uploads/product_images/<?php echo $set_data['product_photo']; ?>"
                                     width="95" height="80"/>
                            <?php } else { ?>
                                <img src="./assets/admin/previewimage.jpg" width="95" height="80"/>
                            <?php } ?>
                        ...
                        <?php if (in_array("vehicle_photo", $privilage)) { ?>
                            <?php if ($set_data['vehicle_photo'] != '') { ?>
                                <img src="./assets/uploads/product_images/<?php echo $set_data['vehicle_photo']; ?>"
                                     width="95" height="80"/>
                            <?php } else { ?>
                                <img src="./assets/admin/previewimage.jpg" width="95" height="80"/>
                            <?php } ?>
...
<tr>
    <td colspan="17">
        <input type="submit" id="DeleteSelected" value="Delete Selected" name="DeleteSelected" class="btn btn-primary"
               onclick="return confirm_box();"/>
        <input type="submit" id="DeleteAll" value="Delete All" name="DeleteAll" class="btn btn-primary"
               onclick="return confirm_box();"/>
    </td>
</tr>
</tbody>
