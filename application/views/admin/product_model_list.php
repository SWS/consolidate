                                            ...
                                            <label>
                                                <div id="" class="selector">
                                                    <a class="floatright" tabindex="0"
                                                       id="data-table_first"
                                                       href="admin/product_model/add_model">ADD</a>
                                                </div>
                                            </label>
                                        </div>
                                </div>
                                ...
                                <div id="data-table_wrapper" class="dataTables_wrapper" role="grid">
                                    <table aria-describedby="data-table_info" class="table table-striped dataTable"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th><?php echo $this->lang->line('') . 'Vehicle Model Name'; ?></th>
                                            <th><?php echo $this->lang->line('') . 'Vehicle Model Image'; ?></th>
                                        ...
                                        if (isset($all_data)) {
                                            foreach ($all_data as $set_data) {
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        <img
                                                            src="<?php echo './assets/uploads/product_model/' . $set_data['model_photo']; ?>"
                                                            width="100" />
                                                    </td>
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        <a href="admin/product_model/edit_model/<?php echo $set_data['id']; ?>">Edit</a>&nbsp;&nbsp;
                                                        <a href="admin/product_model/delete_model/<?php echo $set_data['id']; ?>"
