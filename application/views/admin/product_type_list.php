                            ...
                            <div class="navbar">
                                <div class="navbar-inner">
                                    ...
                                    <div class="control-group row-fluid width50_float_left">
                                        <form action="<?php echo base_url(); ?>admin/product_type/index" method="post"
                                        ...
                                        <label>
                                            <div id="" class="selector">
                                                <a class="floatright" tabindex="0"
                                                   id="data-table_first"
                                                   href="admin/product_type/add_producttype">ADD</a>
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                            ...
                                            foreach ($all_data as $set_data) {
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="dataTables" valign="top"><img
                                                            src="<?php echo './assets/uploads/product_type_images/' . $set_data['Product_Type_Photo']; ?>"
                                                            width="100" />
                                                    </td>
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        ...
                                                        <a href="admin/product_type/delete_product/<?php echo $set_data['id']; ?>"
