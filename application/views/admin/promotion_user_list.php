        ...
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <div class="pull-right">
                    <button id="delete_checked" class="deletebtn">Delete All
                    </button>
                </div>
            </div>
        </div>
        <div class="table-overflow">
            <div id="data-table_wrapper" class="dataTables_wrapper" role="grid">
                <table aria-describedby="data-table_info" class="table table-striped dataTable" id="data-table">
                    ...
                    <thead>
                    <tr role="row">
                        <th colspan="1" rowspan="1"><input id="delete_all_btn" type="checkbox" name="delete_option[]"
                                                           value="all"></th>
                        ...
                        <th colspan="1" rowspan="1"
                            width="150"><?php echo $this->lang->line('') . 'Product Name'; ?></th>
                        <th colspan="1" rowspan="1" width="150"><?php echo $this->lang->line('') . 'Duration'; ?></th>
                        <th colspan="1" rowspan="1"
                            width="150"><?php echo $this->lang->line('') . 'Download Limit'; ?></th>
                    ...
                    foreach ($all_data as $set_data) {
                        if ($set_data['block'] == 0) {
                            ...
                            <tr class="odd">
                                ...
                                <td class="dataTables" valign="top">
                                    <select
                                        onchange="user_status('promotion_form','promotion_duration',<?php echo $set_data['id']; ?>,this.value)"
                                ...
                                <td class="dataTables" valign="top">
                                    <select
                                        onchange="user_status('promotion_form','promotion_download',<?php echo $set_data['id']; ?>,this.value)"
                                        class="width100px" name="martial_id">
                                        <?php
                                        $i = 1;
                                        for ($i; $i <= 10; $i++) {
                                ...
                                <td class="dataTables" valign="top">
                                    <a href="home/user_form/<?php echo md5($set_data['id']); ?>"
                                ...
                                <td class="dataTables" valign="top">
                                    <a href="admin/index/delete/promotion_user/<?php echo $set_data['id']; ?>"
                    ...
                    <tr role="row">
                        ...
                        <th colspan="1" rowspan="1" width="100"><?php echo $this->lang->line('') . 'Country'; ?></th>
                        <th colspan="1" rowspan="1"
                            width="100"><?php echo $this->lang->line('') . 'Product Name'; ?></th>
                    ...
                    foreach ($all_data1 as $set_data) {
                        if ($set_data['block'] == 1) {
                            ...
                            <tr class="odd">
                                ...
                                <td class="dataTables" valign="top">
                                    <a href="admin/index/delete/promotion_block_user/<?php echo $set_data['id']; ?>"
                                       onclick="return confirm_box();">Delete</a>
                                </td>
                            </tr>
                        <?php
