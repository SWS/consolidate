                                    ...
                                    <table aria-describedby="data-table_info" class="table table-striped dataTable"
                                        ...
                                        <tr role="row">
                                            <th colspan="1" rowspan="1"
                                                width=""><?php echo $this->lang->line('') . 'Qestion'; ?></th>
                                            <th colspan="1" rowspan="1"
                                                width="40"><?php echo $this->lang->line('') . 'Duration'; ?></th>
                                            <th colspan="1" rowspan="1"
                                                width="94"><?php echo $this->lang->line('') . 'Minimum Words'; ?></th>
                                            <th colspan="1" rowspan="1"
                                        ...
                                        if (isset($all_data)) {
                                            foreach ($all_data as $set_data) {
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        <select
                                                            onchange="user_status('question',<?php echo $set_data['id']; ?>,this.value)"
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        ...
                                                        <a href="admin/index/delete_question/<?php echo $job_data['id']; ?>/<?php echo $set_data['id']; ?>"
