                            ...
                            <div class="navbar">
                                <div class="navbar-inner">
                                    ...
                                    <div class="control-group row-fluid width50_float_left">
                                        <form action="<?php echo base_url(); ?>serial/index" method="post"
                                              enctype="multipart/form-data" class="form-horizontal">
                                            <div class="controls"><input type="search" id="search" name="search"
                                                                         value="" class="focustip span6"/>
                                    ...
                                    <div class="dataTables_length" id="data-table_length">
                                        <label>
                                            <div id="" class="selector" >
                                                <a  tabindex="0" 
                                                   id="data-table_first" href="admin/serial/add_serial" class="floatright" tabindex="0">ADD</a>
                                            </div>
                                            ...
                                            foreach ($all_data as $set_data) {
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        ...
                                                        <a href="admin/serial/delete/<?php echo $set_data['id']; ?>"
