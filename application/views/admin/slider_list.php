                                        ...
                                        <label>
                                            <div id="" class="selector">
                                                <a class="floatright" tabindex="0"
                                                   id="data-table_first" href="admin/index/add_slider">
                                        ...
                                        if (isset($all_data)) {
                                            foreach ($all_data as $set_data) {
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        <select
                                                            onchange="user_status('slider',<?php echo $set_data['id']; ?>,this.value)"
                                                    ...
                                                    <td class="dataTables" valign="top">
                                                        ...
                                                        <a href="admin/index/delete/slider/<?php echo $set_data['id']; ?>"
