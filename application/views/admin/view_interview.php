    ...
    <div class="outer">
        <div class="inner">
            <div class="page-header">
                <!-- page title -->
                <h5><i class="font-user"></i>View Interview</h5>
                <!-- End page title -->
                <div class="body">
                        ...
                        <div class="row-fluid margintop-30px">
                            ...
                            <div class="span12">
                                ...
                                <div class="block well">
                                    <div class="navbar">
                                        <div class="navbar-inner"><h5>Answer</h5></div>
                                    </div>
                                    <table class="tablemargin" border="0">
                                        ...
                                        if (isset($view_data) && !empty($view_data)) {
                                            ...
                                            foreach ($view_data as $set_data) {
                                                ...
                                                ?>
                                                <tr height="30">
                                                    <td width="100"><span class="FontLarge">Question <?php echo $i; ?></span>
                                                    </td>
                                                ...
                                                <tr height="">
                                                    <td><span class="FontLarge">Answer</span></td>
