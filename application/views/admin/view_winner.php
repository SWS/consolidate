    ...
    <div class="outer">
        <div class="inner">
            <div class="page-header">
                <!-- page title -->
                <h5><i class="font-user"></i><?php echo $this->lang->line('') . 'View Winner'; ?>
                    : <?php echo $set_data['name']; ?></h5>
                <!-- End page title -->
                <div class="body">
                                ...
                                <div id="data-table_wrapper" class="dataTables_wrapper" role="grid">
                                    <table aria-describedby="data-table_info" class="table table-striped dataTable"
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="dataTables"
                                                valign="top"><?php echo $set_data['telephone']; ?></td>
                                        </tr>
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="dataTables"
                                                valign="top"><?php echo $set_data['occupation']; ?></td>
                                        </tr>
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="dataTables"
                                                valign="top"><?php echo $set_data['product_supplier']; ?></td>
                                        </tr>

                                        <tr class="odd">
                                            <td class="dataTables" valign="top">Passport id</td>
                                            <td class="dataTables"
                                                valign="top"><?php echo $set_data['passport_id']; ?></td>
                                        </tr>

                                        <tr class="odd">
                                            <td class="dataTables" valign="top">Winning Date</td>
                                            <td class="dataTables"
                                                valign="top"><?php echo date('m/d/Y', $set_data['created_date']); ?></td>
                                        </tr>

                                        <tr class="odd">
                                            <td class="dataTables" valign="top">Passport</td>
                                            <td class="dataTables" valign="top">
                                                <a href="<?php echo base_url(); ?>assets/uploads/winner_image/<?php echo $set_data['passport_copy']; ?>"
                                                   target="_blank"><img
                                                        src="assets/uploads/winner_image/<?php echo $set_data['passport_copy']; ?>"
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="dataTables" valign="top">
                                                <a href="<?php echo base_url(); ?>assets/uploads/winner_image/<?php echo $set_data['receipt_copy']; ?>"
                                                   target="_blank"><img
                                                        src="assets/uploads/winner_image/<?php echo $set_data['receipt_copy']; ?>"
                                                        width="70" height="70"/></a>
                                            </td>
                                        </tr>
