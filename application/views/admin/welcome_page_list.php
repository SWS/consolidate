...
if (isset($all_data)) {
    foreach ($all_data as $set_data) {
        ...
        <tr height="120" class="odd">
            <td><span class="FontLarge">Time Position</span></td>
            <td width="130"><span class="Font16px">
<?php
...
?>
        ...
        <tr height="" class="odd">
            <td width=""><span class="FontLarge">Logo</span></td>
            <td>
                <?php
            ...
            <td>
                ...
                <?php
                    ...
                    ?>
                    <a href="admin/index/edit_welcome_page/logo/<?php echo $set_data['id']; ?>">Upload</a>&nbsp;&nbsp;
                    <a href="admin/index/empty_data/logo/<?php echo $set_data['id']; ?>"
        ...
        <tr height="">
            <td width="270"><span class="FontLarge">Background Image</span></td>
            <td>
                <?php
            ...
            <td>
                ...
                <?php
                    ...
                    ?>
                    <a href="admin/index/edit_welcome_page/background/<?php echo $set_data['id']; ?>">Upload</a>&nbsp;&nbsp;
                    <a href="admin/index/empty_data/background/<?php echo $set_data['id']; ?>"
                       onclick="return confirm_box();">Delete</a>
                <?php
                }
                ?>
        ...
        <tr height="">
            <td width="170"><span class="FontLarge">Globe Image</span></td>
            <td>
                <?php
            ...
            <td>
                ...
                <?php
                    ...
                    ?>
                    <a href="admin/index/edit_welcome_page/globe/<?php echo $set_data['id']; ?>">Upload</a>&nbsp;&nbsp;
                    <a href="admin/index/empty_data/globe/<?php echo $set_data['id']; ?>"
                       onclick="return confirm_box();">Delete</a>
                <?php
                }
                ?>
        ...
        <tr height="120">
            <td><span class="FontLarge">Globe Position</span></td>
            <td width="130"><span class="Font16px">
<?php
...
?>
            ...
            <td><a href="admin/edit_welcome_page/globe_position/<?php echo $set_data['id']; ?>">Edit</a>&nbsp;&nbsp;
            </td>
        </tr>

        <tr height="120">
            <td><span class="FontLarge">Globe Size</span></td>
            <td width="130"><span class="Font16px">
<?php
...
?>
            ...
            <td><a href="admin/index/edit_welcome_page/globe_size/<?php echo $set_data['id']; ?>">Edit</a>&nbsp;&nbsp;
            </td>
        </tr>

        <tr height="120">
            <td><span class="FontLarge">Product Position</span></td>
            <td width="130"><span class="Font16px">
<?php
...
?>
            ...
            <td><a href="admin/edit_welcome_page/product_position/<?php echo $set_data['id']; ?>">Edit</a>&nbsp;&nbsp;
            </td>
        </tr>

        <tr height="120">
            <td width="170"><span class="FontLarge">Footer Name</span></td>
            ...
            <td>
                ...
                <?php
                    ...
                    <a href="admin/index/empty_data/footer_name/<?php echo $set_data['id']; ?>"
                       onclick="return confirm_box();">Delete</a>
                <?php
                }
                ?>
        ...
        <tr height="120">
            <td width="170"><span class="FontLarge">Admin Mail ID</span></td>
            <td><?php echo $set_data['admin_mail']; ?></td>
            <td>
                <?php
                if ($set_data['admin_mail'] == '') {
                    ?>
                    <a href="admin/index/edit_welcome_page/admin_mail/<?php echo $set_data['id']; ?>">Add</a>&nbsp;&nbsp;
                <?php
                } else {
                    ?>
                    <a href="admin/index/edit_welcome_page/admin_mail/<?php echo $set_data['id']; ?>">Edit</a>&nbsp;&nbsp;
                    <a href="admin/index/empty_data/admin_mail/<?php echo $set_data['id']; ?>"
                       onclick="return confirm_box();">Delete</a>
                <?php
                }
                ?>
        ...
        <tr height="120">
            <td width="170"><span class="FontLarge">Footer</span></td>
            <td>
                <?php
            ...
            <td>
                ...
                <?php
                    ...
                    ?>
                    <a href="admin/index/edit_welcome_page/footer/<?php echo $set_data['id']; ?>">Upload</a>&nbsp;&nbsp;
                    <a href="admin/index/empty_data/footer/<?php echo $set_data['id']; ?>"
                       onclick="return confirm_box();">Delete</a>
                <?php
                }
                ?>
        ...
        <tr height="120">
            <td width="170"><span class="FontLarge">Cart Image</span></td>
            <td>
                <?php
                if (isset($set_data['cart_photo']) && $set_data['cart_photo'] != '') {
            ...
            <td>
                <?php
                if ($set_data['cart_photo'] == '') {
                    ?>
                    <a href="admin/index/edit_welcome_page/cart_photo/<?php echo $set_data['id']; ?>">Upload</a>&nbsp;&nbsp;
                <?php
                } else {
                    ?>
                    <a href="admin/index/edit_welcome_page/cart_photo/<?php echo $set_data['id']; ?>">Upload</a>&nbsp;&nbsp;
                    <a href="admin/index/empty_data/cart_photo/<?php echo $set_data['id']; ?>"
                       onclick="return confirm_box();">Delete</a>
                <?php
                }
                ?>
