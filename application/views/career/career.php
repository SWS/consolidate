...
<script type="text/javascript" src="<?php echo site_url('assets/user/career/js/career.js'); ?>"></script>
            ...
            <form class="form-horizontal" role="form" action="career/apply_form/19" method="post">
                <div class="modal-body">
                    <div class="box-content-modal">
                        <h2 class="title-modal"><?php echo lang('Apply For') ?> <?php if(isset($apply_form['name'])) { echo $apply_form['name']; } ?></h2>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select name="country" id="countries" style="width:245px;">
                        ...
                        <div class="btn-modal">
                            <input type="submit" id="submitapply"
                                   value="Apply" class="kgt3 btn btn-primary btn-sm"/>
                        </div>
                    </div>
                </div>
            </form>
            ...
            if (isset($permanent_job) && !empty($permanent_job)):
                ...
                foreach ($permanent_job as $set_data1):
                    ...
                    <div class="col-md-6">
                        <div class="media row">
                            <div class="col-md-5">
                                <img class="media-object nobottommargin" src="<?php echo $image1; ?>" alt="" width="185" height="180">


                                <a class="btn btn-primary"
                                   href="<?php echo base_url() . 'career/apply_form/' . $set_data1['id']; ?> ">Apply</a>
                            </div>
                            <div class="col-md-7 media-body hidden-xs width55percent">
                                <div class="media-heading" ><?php echo lang('Title') ?>:</div>
                                <span><?php echo $set_data1['name']; ?></span>

                                <div class="media-heading short"><?php echo lang('Scope') ?>:</div>
                                <div class="scope_short short kgt5"><?php echo $set_data1['scope']; ?></div>
                                <div class="clearboth"></div>
                                <div class="hidden_lite show_page_<?php echo $set_data1['id']; ?>">
                                    <div class="media-heading" ><?php echo lang('Scope') ?>:</div>
                                    ...
                                    <div class="clearboth"></div>
                                    <div class="media-heading" ><?php echo lang('Qualification') ?>:</div>
                                    <?php
                                    foreach ($filters as $filter) {
                                ...
                                <a id="page_<?php echo $set_data1['id']; ?>" class="show_page readmore1"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body hidden-xs">
                                ...
                                <div class="media-heading short" ><?php echo lang('Scope') ?>:</div>
                                <div class="scope_short short kgt5"><?php echo $set_data2['scope']; ?></div>
                                <div class="clearboth"></div>
                                <div class="hidden_lite show_page_<?php echo $set_data2['id']; ?>">
                                    <div class="media-heading" ><?php echo lang('Scope') ?>:
                                    </div><?php echo $set_data2['scope']; ?>
                                    <br/>

                                    <div class="clearboth"></div>
                                    <div class="media-heading" ><?php echo lang('Qualification') ?>:
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body hidden-xs">
                                ...
                                <div class="scope_short short kgt5"><?php echo $set_data3['scope']; ?></div>
                                <div class="clearboth"></div>
                                ...
                                <a class="readmore show_page" id="page_<?php echo $set_data3['id']; ?>"
                                   data-value="<?php echo $set_data3['id']; ?>"
                                   href=""><?php echo lang('Read') . ' '; ?><span
                                        class="moretext"><?php echo lang('More') ?></span><span
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body hidden-xs">
                                ...
                                <div class="scope_short short kgt5"><?php echo $set_data4['scope']; ?></div>
                                <div class="clearboth"></div>
                                ...
                                <a class="readmore show_page" id="page_<?php echo $set_data4['id']; ?>"
                                   data-value="<?php echo $set_data4['id']; ?>"
                                   href=""><?php echo lang('Read') . ' '; ?><span
                                        class="moretext"><?php echo lang('More') ?></span><span
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="box-content-modal">
                    ...
                    <div class="clearfix"></div>
                    <div class="btn-modal">
                        <a href="javascript:" onClick="$('.modal_block').modal('hide')"
