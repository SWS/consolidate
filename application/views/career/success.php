<script type="text/javascript" src="<?php echo site_url('assets/user/career/js/success.js'); ?>"></script>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="box-content-modal">
                    <h2 class="title-modal"><?php echo $career_msg[0]['modal_success_header']; ?></h2>
                    <p>
                        <?php
