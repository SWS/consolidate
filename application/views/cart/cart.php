        ...
        <div class="main-page">
            <div class="car-lists productlisting">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="salutation" id="salutation" class="form-control selectpicker1 kgt2">
                                        <option value='Mr.' data-title="Mr" <?php if ($cart_users_data1['user_name'] == 'Mr.') { ?> selected="selected"<?php } ?>>
                                            Mr.
                                        </option>
                                        <option value='Ms.' data-title="Ms" <?php if ($cart_users_data1['user_name'] == 'Ms.') { ?> selected="selected"<?php } ?>>
                                            Ms.
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="cart_surname" placeholder="Name and Surname"
                                           name="surname"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="cart_company" placeholder="Company" name="company"
                                           value="<?php echo isset($cart_users_data['company']) ? $cart_users_data['company'] : '' ?>"
                                           required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="cart_address" placeholder="Address" name="address"
                                           value="<?php echo isset($cart_users_data['address']) ? $cart_users_data['address'] : '' ?>"
                                           required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="cart_designation" placeholder="Designation"
                                           name="designation"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8" id="popupboxcountrywrap">
                                    ...
                                    <select name="country" id="cart_country" class="form-control selectpicker1 kgt2">
                                        <?php foreach ($countries as $country) { ?>
                                            <option value='<?php echo htmlentities($country['countryName'], ENT_QUOTES); ?>'
                                                    ...
                                                    data-title="<?php echo htmlentities($country['countryName']); ?>" <?php if ($country['countryName'] == "Canada") { ?> selected="selected"<?php } ?>><?php echo $country['countryName']; ?></option>
                                                <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="cart_telephone" placeholder="Telephone" name="telephone"
                                           value="<?php echo isset($cart_users_data['telephone']) ? $cart_users_data['telephone'] : '' ?>"
                                           required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="cart_email" placeholder="Email" name="email"
                                           value="<?php if (count($cart_users_data) > 0) echo isset($cart_users_data['email']) ? $cart_users_data['email'] : '' ?>"
                                           required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control datetimepicker" id="cart_deadline" placeholder="Deadline"
                                           name="deadline"
                                           value="<?php echo isset($cart_users_data['deadline']) ? $cart_users_data['deadline'] : '' ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 aligncenter" id="cart_rfq_number">
                                    <?php
                                    ...
                                    <input type="hidden" name="rfq"
                                           value="<?php echo isset($cart_users_data['rfq']) ? $cart_users_data['rfq'] : $randomString; ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="incoterms" class="col-sm-4 control-label"><?php echo lang('Incoterms') ?></label>
                                <div class="col-sm-8">
                                    <select name="incoterms" id="incoterms" class="form-control selectpicker1 kgt2">
                        ...
                        <div class="col-md-6">
                            <div class="kgtimage542box"><img
                                    src="assets/uploads/cart/<?php echo isset($cart_image) ? $cart_image : ''; ?>"
                                    class="kgtimage542px" alt="Cart"></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <?php if (!empty($cart_details)) {
                            ...
                            <div class="table-responsive" id="not_empty_cart">
                                ...
                                <table id="kgtcartactive" class="table table-bordered my-table productsbytype">
                                    ...
                                    foreach ($cart_details as $cart) {
                                        ...
                                        ?>
                                        <input type="hidden" value="<?php echo $cart['id']; ?>" name="product_id[]" class="width50px">
                                        <?php
                                        if ($currentproducttype != $cart['type']) {
                                            ...
                                            <th colspan="11"><?php echo $cart['type']; ?>
                                                <input type="button" id="minimize_block_<?php echo $cart['id']; ?>" class="minimize_block floatright1"
                                                       name="minimize_block" value="-"></th>
                                            </thead>
                                            ...
                                            <tr class="cart_details_row cart_details_row_<?php echo $cart['id']; ?>">
                                                <td><span><a href="javascript:void(0);" class="black1" onClick="remove_cart(this,<?php echo $cart['id']; ?>);"><i class="fa fa-times"></i></a></span>
                                                </td>
                                                <td class="font575757 cart_item_count"><span><?php echo $i; ?></span></td>
                                                <td><span class="font575757">
                                                        <input type="text" value="<?php echo $cart['quantity']; ?>" class="width50px" name="quantity[<?php echo $cart['id'] ?>]">
                                                    </span></td>
                                                ...
                                                <td class="font575757"><span>
                                                        ...
                                                        <?php if ($cart['product_photo'] != '' && file_exists("assets/uploads/product_images/" . $cart['product_photo'])) { ?>
                                                            ...
                                                            <a class="example-image-link"
                                                               data-lightbox="example-<?php echo $cart['id']; ?>"
                                                        ...
                                                        <?php if ($cart['vehicle_photo'] != '' && file_exists("assets/uploads/product_images/" . $cart['vehicle_photo'])) { ?>
                                                            <a class="example-image-link"
                                                               ...
                                                               href="assets/uploads/product_images/<?php echo $cart['vehicle_photo']; ?>">
                                                                <img
                                                                    src="assets/uploads/product_images/<?php echo $cart['vehicle_photo']; ?>"
                                                                    height="75" alt="<?php echo $cart['vehicle_photo']; ?>"/>
                                                            </a>&nbsp;
                                                        <?php } else { ?>
                                                            <a class="example-image-link"
                                                               data-lightbox="example-<?php echo $cart['id']; ?>"
                                                            ...
                                                            <?php if ($cart['drawing_photo'] != '' && file_exists("assets/uploads/product_images/" . $cart['drawing_photo'])) { ?>
                                                                <a class="example-image-link"
                                                                   ...
                                                                   href="assets/uploads/product_images/<?php echo $cart['drawing_photo']; ?>">
                                                                    <img
                                                                        src="assets/uploads/product_images/<?php echo $cart['drawing_photo']; ?>"
                                                                        alt="<?php echo $cart['drawing_photo']; ?>"
                                                                        height="75"/> </a>&nbsp;
                                                                <?php } else { ?>
                                                                <a class="example-image-link"
                                                                   data-lightbox="example-<?php echo $cart['id']; ?>"
                                            ...
                                            <tr class="less_info cart_details_row_<?php echo $cart['id']; ?> bgrgb219a">
                            ...
                            <div id="empty_cart" class="out-box-modal displaynon">
                ...
                <div class="nav-prex-next text-right" id="cart_buttons">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="javscript:void(0)" class="btn btn-primary btn-sm" id="cart_back"><?php echo lang('Back') ?></a>
                            <a href="javscript:void(0)" class="btn btn-primary btn-sm"
                               id="cart_continue_shopping"><?php echo lang('CONTINUE SHOPPING') ?></a> <a href="javascript:void(0)"
                               class="btn btn-primary btn-sm"
                               id="cart_checkout"><?php echo lang('SUBMIT') ?></a>
                        </div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="box-content-modal">
                    ...
                    <div class="btn-modal">
                        <div class="row">
                            <div class="col-md-12 col-xs-12 text-right"><a href="javascript:void(0)"
                                                                           onClick="$('#user_block_box').modal('hide');
                                                                                   window.location.href = ' <?php echo base_url(); ?>cart/index'"
                                                                           class="btn btn-primary btn-sm"
                                                                           id="block_confirm_msg"><?php echo lang('OK') ?>
                ...
                <div class="modal-content">                          
                  <div class="modal-body">
                    ...
                    <div class="btn-modal">
                        <div class="row">
                            <div class="col-md-12 col-xs-12 text-right"><a href="javascript:void(0)"
                                                                           onClick="$('#main_cart_block_box').modal('hide');
                                                                                   window.location.href = ' <?php echo base_url(); ?>cart/clear_user_session'"
                                                                           class="btn btn-primary btn-sm"
                                                                           id="block_confirm_msg2"><?php echo lang('OK') ?>
                                    <i class="glyphicon glyphicon-chevron-right"></i></a></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <div class="box-content-modal">
                    ...
                    <div class="blockElementWrap">
                        ...
                        ?>
                        <div class="blockMsg" id="blockMsg2">Unfortunately, you did not finish shopping during the given
                            lead-time. Therefore, you will be welcome to use an alternative email or wait for 120
                            minutes to use the current email <?php echo $email; ?> within our website.
                        </div>
