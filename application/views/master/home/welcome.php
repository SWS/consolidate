...
if (isset($all_data['background_image']) && $all_data['background_image']) {
                        ...
                        <ul>
                            ...
                            if (isset($country_data) && !empty($country_data)) {
                                ...
                                foreach ($country_data as $set_data) {
                                    ...
                                    <a href="javascript:" onclick="return false;"> <img class="flag"
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h2 class="title-modal">This version is still under development. Please check back later. Thank
                        you</h2>
                        ...
                        <div class="row floatright1">
                            ...
                            <div class="col-xs-3 col-md-2 text-center"><a href="#"
                                                                          onClick="$('#language_popup').modal('hide');return false;"
    ...
    <div id="content">
        ...
        <canvas id="sphere" class="<?= (isset($all_data['globe_size'])) ? $all_data['globe_size'] : 'medium' ?>"
    ...
    <div class="height91percent"></div>

    <div class="height9percent">
