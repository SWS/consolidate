                ...
                <div class="fb1">
                    ...
                    <div>
                        ...
                        <ul class="kgtclientul">
                            ...
                            <li><a href="<?= base_url() ?>products" class=""><?php echo lang('Get Instant Quote') ?></a>
                            </li>

                            <li><a href="javascript:" class="login_pop"><?php echo lang('Claim Warranty') ?></a></li>

                            <li><a href="<?= base_url() ?>promotion/awards"
                                   class=""><?php echo lang('Claim Award') ?></a></li>
                ...
                <div class="row">
                            ...
                            if (!empty($download)) {
                                ...
                                foreach ($download as $set_data) {
                                    ...
                                    <a href="<?=base_url()?>promotion/index#knowledge_center">
                                        ...
                                        <span
                                            class="font575757-a"><?= $set_data['name'] ?></span></a>
                                    <br/>
                    ...
                    <div class="col-md-6 col-xs-6">
                        ...
                        <div class="fb2_inside2">
                            ...
                            <a href="<?= base_url() ?>promotion"><span
                        ...
                        <div class="fb2_inside4 col-md-6 col-xs-6">
                            ...
                            <a href="<?= base_url() ?>career#part_time_job"
                               onClick="goUrl('<?= base_url() ?>career#part_time_job')"><span
                                    ...
                                    &nbsp;(<?php echo count($part_time); ?>)</span>(<?php echo count($part_time); ?>
                                )</a><br/>
                            ...
                            <a href="<?= base_url() ?>career#projects_contractors"
                               onClick="goUrl('<?= base_url() ?>career#projects_contractors')"><span
                                    ...
                                    &nbsp;(<?php echo count($projects_contractors); ?>)</span>
                                (<?php echo count($projects_contractors); ?>)</a></div>
                    ...
                    <div class="col-md-6 social text-right">
                        ...
                        <div class="displayinlineblock margintop10px">
                            ...
                            <a href="javascript:" onClick="$('#underconstruction_popup').modal('show');"> <img
                                    src="<?= global_img_link('facebook_icon.png', 'template/images/') ?>" alt=""/> </a>

                            <a href="javascript:" onClick="$('#underconstruction_popup').modal('show');"> <img
                                    src="<?= global_img_link('icon2.png', 'template/images/') ?>" alt=""/> </a>

                            <a href="javascript:" onClick="$('#underconstruction_popup').modal('show');"> <img
                                    src="<?= global_img_link('youtube_icon.png', 'template/images/') ?>" alt=""/> </a>
                ...
                <div class="box-content-modal">
                    ...
                    <div class="btn-modal">                     
                        ...
                        <div class="row marginleft65px">
                            ...
                            <div class="col-xs-4 col-md-4 text-center"><a href="javascript:"
                    ...
                    <div class="btn-modal"> <br />
                        ...
                        <div class="row marginleftright10px">
                            ...
                            <div class="col-xs-3 col-md-3 text-center"><a href="contact"
                                                                          class="btn btn-primary btn-sm popuplogin">Contact
                                    KGT <i class="glyphicon glyphicon-chevron-right"></i></a></div>
                            ...
                            <div class="col-xs-3 col-md-3 text-center"><a href="contact"
                                                                          class="btn btn-primary btn-sm popuplogin">Forget
                                    user name <i class="glyphicon glyphicon-chevron-right"></i></a></div>

                            <div class="col-xs-3 col-md-2 text-center"><a href="javascript:"
