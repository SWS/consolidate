        ...
        <div class="container">
            <div class="header">
                <div class="row minheight130px">
                    <div class="col-md-3">
                        <a class="logo" href="<?= base_url() ?>home"><img src="<?= img_url('logo.png', 'master/') ?>" alt="logo"
                                                                          class="floatleft1"/></a>
                    </div>
                    <div class="col-md-6 col-xs-5 block-bg-header hidden-xs">
                        <a href="<?= base_url() ?>products"><img src="<?= img_url('logo-pic.png', 'master/') ?>"
                                                                 alt="Products Logo"> </a>
                    </div>
                    <div class="col-md-3 floatright1">
                        <div class="ddl">
                            ...
                            <div class="box">
                                ...
                                <div class="date-sec">
                                    <div  id="dateActive" class="date-time color-white datewidth"></div>
                                    <div class="sep"></div>
                ...
                <div class="row">
                    <div class="text-header">
                        ...
                        <div class="col-md-3 col-md-offset-1 text-right text-2">
                            <h4>
                                <a class="distribution_link blink" href="distribution">Apply for A
                                    Distribution Agrement</a>
                            </h4>
                        </div>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                        <ul class="nav navbar-nav parent">
                                            <li class="dropdown">
                                                <a href="home" class="dropdown-toggle1" data-toggle="dropdown1">Home <b
                                                        class="caret"></b></a>
                                                ...
                                                <?php if (isset($menu_vehicle_categories) && !empty($menu_vehicle_categories)) { ?>
                                                    <ul class="dropdown-menu">
                                                        <?php foreach ($menu_vehicle_categories as $vehicle_categories1) { ?>
                                                            <li>
                                                                <a href="products/product_type/<?php echo $vehicle_categories1['id']; ?>"
                                                                   class="cars"
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a style="background: url('<?= global_img_link($menu_img_link['follow_up_order'], "uploads/menus/") ?>') no-repeat scroll right center transparent;"
                                                           href="#"
                                                           class="login_pop"><?php echo $menu_label['follow_up_order']; ?></a>
                                                    </li>
                                                    <li>
                                                        <a style="background: url('<?= global_img_link($menu_img_link['get_instant_quo'], "uploads/menus/") ?>') no-repeat scroll right center transparent;"
                                                           href="<?= base_url() ?>products"
                                                           class=""><?php echo $menu_label['get_instant_quo']; ?></a></li>
                                                    <li>
                                                        <a style="background: url('<?= global_img_link($menu_img_link['warranty_claim'], "uploads/menus/") ?>') no-repeat scroll right center transparent;"
                                                           href="#"
                                                           class="login_pop"><?php echo $menu_label['warranty_claim']; ?></a>
                                                    </li>
                                                    <li>
                                                        <a style="background: url('<?= global_img_link($menu_img_link['claim_award'], "uploads/menus/") ?>') no-repeat scroll right center transparent;"
                                                           href="<?= base_url() ?>promotion/awards"
                                                           class=""><?php echo $menu_label['claim_award']; ?></a></li>

                                                </ul>
                                            </li>
                                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Supplier
                                                    &amp; Investor Section <b class="caret"></b></a>
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a style="background: url('<?= global_img_link($menu_img_link['supplier'], "uploads/menus/") ?>') no-repeat scroll right center transparent;"
                                                           href="#" class="login_pop"><?php echo $menu_label['supplier']; ?></a>
                                                    </li>
                                                    <li>
                                                        <a style="background: url('<?= global_img_link($menu_img_link['investor'], "uploads/menus/") ?>') no-repeat scroll right center transparent;"
                                                           href="#" class="login_pop"><?php echo $menu_label['investor']; ?></a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li>
