            ...
            <span class="font22pxarial">
                ...
                <a onclick="showHide('.brand_complete_info_<?php echo $product_type->maker_id; ?>')"
                   href="javascript:void(0)">
                    ...
                    <img alt=" - " src=""
                         class="brand_complete_info_<?php echo $product_type->maker_id; ?>_less_img black2-displayinline">

                    <img alt=" + " src=""
                         class="brand_complete_info_<?php echo $product_type->maker_id; ?>_more_img black2-nodisplay">
                                ...
                                <td class="font575757">
                                    ...
                                    <a href="javascript:void(0)"
                                       onClick="$(this).parent().parent().next('.less_info').toggle();$(this).find('.less_img').toggle();$(this).find('.more_img').toggle();">
                                        ...
                                        <img src="" class="more_img black2-nodisplay"
                                             alt=" + "/>
