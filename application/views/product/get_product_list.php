    ...
    if ($product_maker_id != $product_type->maker_id) {
        ...
        <h1 class="nomargin">
            ...
            <input id="Checkbox_<?php echo $product_type->maker_id; ?>"
                   name="Checkbox_<?php echo $product_type->maker_id; ?>" type="checkbox"  <?php echo $checkbox; ?>
            ...
            <span class="font22pxarial">
                ...
                <a onclick="showHide('.brand_complete_info_<?php echo $product_type->maker_id; ?>')"
                   href="javascript:void(0)">
                    ...
                    <img alt=" - " src=""
                         class="black2-displayinline brand_complete_info_<?php echo $product_type->maker_id; ?>_less_img">

                    <img alt=" + " rc=""
                         class="black2-nodisplay brand_complete_info_<?php echo $product_type->maker_id; ?>_more_img">
                ...
                if (($product_model->model_id != $product_model_id) && ($product_type->maker_id == $product_model->maker_id)) {
                    ...
                    <h1 class="nomargin">
                        ...
                        <input id="Checkbox_model_<?php echo $product_model->model_id; ?>"
                               name="Checkbox_model_<?php echo $product_model->model_id; ?>"
                               type="checkbox"  <?php echo $checkbox; ?>
                            ...
                            <span class="font22pxarial"> 
                                ...
                                <a onclick="showHide('.model_table_<?php echo $chkbox_model_id; ?>')"
                                   href="javascript:void(0)">
                                    ...
                                    <img alt=" - " src="" class="black2-displayinline model_table_<?php echo $chkbox_model_id; ?>_less_img">

                                    <img alt=" + " src="" class="black2-nodisplay model_table_<?php echo $chkbox_model_id; ?>_more_img">
                    ...
                    foreach ($products as $product) {
                            ...
                            <table
                                ...
                                >
                                        ...
                                        <input id="Checkbox_product_type_<?php echo $product->id; ?>"
                                               type="checkbox"  <?php echo $checkbox; ?>
                            ...
                            <tr class="main_info bgrgb219">
                                ...
                                <td class="width60px"><span><input id="Checkbox_product_<?php echo $product->id; ?>"
                                                                     type="checkbox"  <?php echo $checkbox; ?>
                            ...
                            ?>
                                ...
                                <td class="font575757">
                                    ...
                                    <a href="javascript:void(0)"
                                       onClick="$(this).parent().parent().next('.less_info').toggle();$(this).find('.less_img').toggle();$(this).find('.more_img').toggle();">

                                        <img src="" class="less_img black2-displayinline"
                                             alt=" - "/>

                                        <img src="" class="more_imgblack2 black2-nodisplay"
                                             alt=" + "/>
