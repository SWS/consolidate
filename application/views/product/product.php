...
<div class="container">
    <div class="main-page">
        <div class="red1"><span class="fontblack">Selection instruction : </span><?php echo $selection_instruction[0]->product_msg; ?>
        </div>
        <div class="car-lists text-center productbaselisting">
            <div class="col-md-12">
                <?php include('product_timer.php'); ?>
                <form action="products/product_type" id="products_catagory_list_form" enctype="multipart/form-data"
                      method="post">
                    <div class="product-list pull-left">
                        <div class="col-md-12">
                            ...
                            <?php if ($this->comman_model->get_isactive_checkbox('settings', 'id', 1)) { ?>
                                <div id="vehicle_check_all_btn" class="col-md-6 custom_btn marginleft25px">
                                    <input id="checkbox_vehicle" type="checkbox" name="vehicle_option[]" value="all">
                                    Select All Vehicle Type (<span
                    ...
                    <div class="product-list pull-right">                          
                        <div class="col-md-12">
                            ...
                            <?php if ($this->comman_model->get_isactive_checkbox('settings', 'id', 1)) { ?>
                                <div id="product_check_all_btn" class="col-md-6 custom_btn marginleft25px">
                                    <input id="checkbox_product_option" type="checkbox" name="product_option[]"
                                           value="all">
                                    Select All Product Type (<span
                                        id="menu_product_types_num"><?php echo count($menu_product_types); ?></span>)
                                </div>
                            <?php } ?>
                        </div>
                        <div class="clearfix"></div>
                                ...
                                <div class="col-md-6 VehicleBlockItems">
                                    <div class="pro-item product_type_image_wrap step1">
                                        <div class="height180px overflowhidden">
                                            ...
                                            <a href="javascript:void(0);" class="product_image_wrap"
                                               data-rel="<?php echo strtolower(str_replace(' ', '_', $pro_type->product_type_name)); ?>"><img
                                                    src="assets/uploads/product_type_images/<?php echo $pro_type->Product_Type_Photo; ?>"
                                                    width="165" id="image_product_id_<?php echo $pro_type->id; ?>"
                                                    alt="<?php echo $pro_type->product_type_name; ?>"/></a>
                                            <input type="hidden" name="product_type_id[]" value=""
                                                   class="product_types_id">
                                        </div>
                                        <div class="clearfix"></div>
                                        <a href="javascript:void(0);"
                                           class="btn btn-primary btn-sm Type_title"><?php echo $pro_type->product_type_name; ?></a>
                                    </div>
                                </div>
                            <?php } ?>
                        </div>
