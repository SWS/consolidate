            ...
            <div class="modal-body">
                <div class="box-content-modal">
                    <div class="blockElementWrap">
                        ...
                        <div class="blockMsg">Unfortunately, you did not finish shopping during the given lead-time.
                            Therefore, you will be welcome to use an alternative email or wait for 120 minutes to use
                            the current email <?php echo $email; ?> within our website.
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xs-12 text-right">
                                <a href="javascript:void(0)" onClick="
                                   ...
                                   class="btn btn-primary btn-sm nopadding" id="block_confirm_msg"><?php echo lang('OK') ?> <i
