    ...
    <div style="border:solid #666">
        <div style="background-color:#000;color:#FFF;text-align:center;">
            <img src="<?php echo base_url() . 'assets/template/images/logo.png'; ?>" style="border-width:0px; padding: 4px 0px 1px 9px;">
                    <h1 style="margin:0px;line-height:70px;font-style:italic; font-weight:normal;">Your Information</h1>
        </div>
                    <div style="background-color:#FFF;color:#000;">
                        <h3 style="margin-left:20px;line-height:50px; font-weight:normal;">Dear <?php echo $name; ?>,</h3>
                    <p style="margin-left:20px;font-size:12px">Thanks for contacting us , We will get back to you shortly.</p></div>
                    <div style="padding:20px">
                    <h2 style="font-weight:normal;">Your Information</h2>
                    <table>
