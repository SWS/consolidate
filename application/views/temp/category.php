                            ...
                            <div class="col-md-6">
                                <div class="media">
                                    <div class="floatleft1">
                                        ...
                                        <p class="visible-xs media-heading black1"><?php echo $set_data1['name']; ?></p>
                                        <a class="btn btn-primary"
                                           href="front/view_promotion/<?php echo $set_data1['id']; ?>"><?php echo lang('Read More') ?></a>
...
<br />
                                            ...
                                            <a class="openPop btn btn-primary" href="#"
                                               id="<?php echo $set_data1['id']; ?>"
                                               value="<?php echo $set_data1['name']; ?>"><?php echo lang('Download') ?></a>
                                        <?php
                                        }
                                        ?>
                                    </div>
