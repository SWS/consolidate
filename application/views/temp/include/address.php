                    ...
                    <?php
                        ...
                        if (isset($page_data)) {
                            ...
                            <a href="home">Home</a> / <a
                                href="front/promotion">Promotion</a> / <?php echo $page_data['name']; ?>
                        <?php
                        } else {
                            ?>
                        ...
                        if (isset($apply_form)) {
                            ?>
                            <a href="home">Home</a> / <a
                                href="front/promotion">Promotion</a> / <?php echo $apply_form['name']; ?>
                        <?php
                        }
                        ...
                        if (isset($category)) {
                            ?>
                            <a href="home">Home</a> / <a
                                href="front/promotion">Promotion</a> / <?php echo $category['name']; ?>
                        <?php
                        } else {
                            ?>
                            <a href="home">Home</a> / Promotion
