...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#notify_panel_close_button').click(function (e) {
            $('#notify_panel').modal('hide');
            return false;
        })
        $('#code_verification_ok_verify_button').click(function (e) {
            fn_Verify_Code($('div#modal_dist_popup .email').val(), $('#txt_verification_code').val());
            return false;
        })
        $('#code_verification_resend_code_button').click(function (e) {
            fn_Send_Verification_Code($('div#modal_dist_popup .email').val(), $('div#modal_dist_popup .applicant').val(), 1, $('div#modal_dist_popup #hdn_country_name').val(), $('div#modal_dist_popup .telephone').val());
            return false;
        })
        $('#code_verification_cancel_button').click(function (e) {
            fn_Send_Block($('div#modal_dist_popup .email').val(), $('div#modal_dist_popup .applicant').val(), $('div#modal_dist_popup #hdn_country_name').val(), $('div#modal_dist_popup .telephone').val(), 1);
            return false;
        })
        $('.code_verification_block_close_button').click(function (e) {
            fn_Handle_Block(2, <?php echo isset($str_Edit) ? $str_Edit : "true"; ?>);
        })
        $('#code_verification1 .code_verification_block_close_button').click(function (e) {
            fn_Handle_Block(2, <?php echo isset($str_Edit) ? $str_Edit : "true"; ?>);
        })
        $('#blck_confirm_msg').click(function (e) {
            fn_Handle_Block(1, <?php echo isset($bln_Edit) ? $bln_Edit : "false"; ?>);
        })
        $('#blck_confirm_msg1').click(function (e) {
            fn_Handle_Block(6, <?php echo isset($bln_Edit) ? $bln_Edit : "false"; ?>);
        })
        $('#company').keyup(function (e) {
            fn_UpdateValues(this.value, 'spn_id_Company_1,spn_id_Company_2,spn_id_Company_3');
            fn_Handle_Fields('txt', this.value, 'applicant');
        })
        $('#company').change(function (e) {
            fn_UpdateValues(this.value, 'spn_id_Company_1,spn_id_Company_2,spn_id_Company_3');
            fn_Handle_Fields('txt', this.value, 'applicant');
        })
        $('.applicant').keyup(function (e) {
            fn_UpdateValues(this.value, 'spn_id_Applicant_1');
            fn_Handle_Fields('txt', this.value, 'country');
        })
        ...
        $('#country').change(function (e) {
            fn_Handle_Fields('dd', this.selectedIndex, 'address');
        })
        $('#country').click(function (e) {
            fn_Handle_Fields('dd', this.selectedIndex, 'address');
        })
        $('.address').keyup(function (e) {
            fn_Handle_Fields('txt', this.value, 'designation');
        })
        $('.address').change(function (e) {
            fn_Handle_Fields('txt', this.value, 'designation');
        })
        $('.designation').keyup(function (e) {
            fn_Handle_Fields('txt', this.value, 'telephone');
        })
        $('.designation').change(function (e) {
            fn_Handle_Fields('txt', this.value, 'telephone');
        })
        $('.telephone').keyup(function (e) {
            fn_Handle_Fields('txt', this.value, 'email');
        })
        $('.telephone').change(function (e) {
            fn_Handle_Fields('txt', this.value, 'email');
        })
        $('.email').keyup(function (e) {
            fn_Handle_Fields('email', this.value, 'license');
        })
        $('.email').change(function (e) {
            fn_Handle_Fields('email', this.value, 'license');
        })
        $('.email').blur(function (e) {
            fn_Check_Email(this.value);
        })
        $('.license').change(function (e) {
            fn_Handle_Fields('license', 1, 'companysize_medium');
            fn_Handle_Fields('license', 1, 'companysize_big');
        })
        $('.companysize_big').click(function (e) {
            fn_Handle_Fields('txt', 'checked', 'companystart_brake_pads');
            fn_Handle_Fields('txt', 'checked', 'companystart_filters');
            fn_Handle_Fields('txt', 'checked', 'companystart_brake_lining');
        })
        $('.companysize_medium').click(function (e) {
            fn_Handle_Fields('txt', 'checked', 'companystart_brake_pads');
            fn_Handle_Fields('txt', 'checked', 'companystart_filters');
            fn_Handle_Fields('txt', 'checked', 'companystart_brake_lining');
        })
        $('.companystart_brake_pads').click(function (e) {
            fn_Handle_Fields('txt', 'checked', 'chk_id_agree');
        })
        $('.companystart_filters').click(function (e) {
            fn_Handle_Fields('txt', 'checked', 'chk_id_agree');
        })
        $('.companystart_brake_lining').click(function (e) {
            fn_Handle_Fields('txt', 'checked', 'chk_id_agree');
        })
        $('.chk_id_agree').change(function (e) {
            fn_Handle_Fields('txt', 'checked', 'sel_id_indoor_sales');
        })
        $('.sel_id_indoor_sales').click(function (e) {
            fn_Handle_Fields('sel', this.selectedIndex, 'sel_id_outdoor_sales');
        })
        $('.sel_id_outdoor_sales').click(function (e) {
            fn_Handle_Fields('sel', this.selectedIndex, 'txt_id_salesbrief');
        })
        $('.txt_id_salesbrief').keyup(function (e) {
            fn_Handle_Fields('txt', this.value, 'chk_id_signup');
        })
        $('.txt_id_salesbrief').change(function (e) {
            fn_Handle_Fields('txt', this.value, 'chk_id_signup');
        })
        $('#modal_dist_popup_cancel_button').click(function (e) {
            fn_Send_Block('', $('.applicant').val(), $('#country_title').text(), $('.telephone').val(), 1);
            return false;
        })
        $('#modal_dist_popup_submit_button').click(function (e) {
            fn_Handle_Submit_Verification(1);
            return false;
        })
        $('#modal_dist_preview_popup_back_button').click(function (e) {
            fn_Edit_Form();
        })
        $('#modal_dist_preview_popup_submit_button').click(function (e) {
            if (typeof clock !== "undefined") clock.reset();
            fn_Send_Verification_Code($('div#modal_dist_popup .email').val(), $('div#modal_dist_popup .applicant').val(), 0, $('div#modal_dist_popup #hdn_country_name').val(), $('div#modal_dist_popup .telephone').val());
            return false;
        })
        $('#cancel').click(function (e) {
            fn_Send_Block('', $('div#modal_dist_popup .applicant').val(), $('div#modal_dist_popup #hdn_country_name').val(), $('div#modal_dist_popup .telephone').val(), 1);
            return false;
        })
    });
</script>
