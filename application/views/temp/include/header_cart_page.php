                                ...
                                <ul class="nav navbar-nav parent">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="home/truck_brand" class="others">Others</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="home/promotion">Promotion Section</a>
                                    </li>
                                    <li class="dropdown">
                                    ...
                                    <li>
                                        <a href="home/cart_filter_final"><img src="assets/template/images/cart.png"
                                                                              alt="cart"/> <span id="menu_cart_id">Cart [<?php echo $cartcount; ?>
                                                ]</span></a>
                                    </li>
                                </ul>
