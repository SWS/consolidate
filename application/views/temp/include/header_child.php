            ...
            <div class="row minheight130px">
                ...
                <div class="col-md-3">
                    <div class="ddl">
                        ...
                        <div class="box">
                            <label class="kgt76">Wednesday.
                                February 12, 2014</label>
                            <hr class="kgt77"/>
                            <label
                                class="kgt78">11&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;34&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;PM</label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="text-header">
                <div class="col-md-3 col-md-offset-2 text-right text-1">
                    <h3 class="notopmargin">We Export Around the Globe</h3>
                </div>
                <div class="col-md-3 col-md-offset-2 text-right text-2">
                    <h4>
                        <a href="home/distribution">Apply for A Distribution Agrement </a>
                    </h4>
                </div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav parent">
                                    <li class="dropdown">
                                        <a href="home/" class="dropdown-toggle" data-toggle="dropdown">Home <b
                                                class="caret"></b></a>
                                            ...
                                            foreach ($menu_vehicle_categories as $vehicle_categories1) {
                                                ...
                                                <li>
                                                    <a href="products/product_type/<?php echo $vehicle_categories1['id']; ?>"
                                                       class="cars"
                                                       style="background: url('assets/uploads/vehicle_categories/<?php echo $vehicle_categories1['menu_image']; ?>') no-repeat scroll right center transparent;"><?php echo $vehicle_categories1['category_name']; ?></a>
                                                </li>
                                            <?php } ?>
                                    ...
                                    <li>
                                        <a href="cart/cart"><img src="assets/template/images/cart.png" alt="cart"/>
                                            <span id="menu_cart_id">Cart [<?php echo $cartcount; ?>]</span></a>
                                    </li>
                                </ul>
