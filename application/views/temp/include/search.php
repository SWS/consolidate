<div class="col-md-3">
    <div class="searchdiv">
        <label for="Search" class="displaynon"><?php echo lang('Search') ?>  </label>
                    ...
                    <div class="row">
                        <form method="post" enctype="multipart/form-data" id="senditemenquiry"
                            ...
                            <div class="col-md-10 col-md-offset-1">
                                We did not recognize your part number <span id="spnsearchedpartnumber"></span>. Please
                                send us a detailed email about it and we will cross-reference it and revert accordingly.
                            </div>
                        </form>
                    </div>
                    <br/>
                    ...
                    <div class="btn-modal">
                        <div class="row">
                            <div class="col-md-12 col-xs-12 text-right">
                                <img id="loaderimage" class="displaynon" src="images/loading.gif" alt="Loading"/>&nbsp;<a
                                    href="javascript:" class="btn btn-primary btn-sm floatleft1" id="enquirysubmit_contctredirect"
                                    >OK <i class="glyphicon glyphicon-chevron-right"></i></a>&nbsp;&nbsp;
                                <a href="javascript:"
                                   onClick="$('#enquiry_partnumber_details').modal('hide')"
                                   class="floatright1 btn btn-primary btn-sm"><?php echo lang('Cancel') ?> <i
