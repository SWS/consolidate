                    ...
                    <div class="col-md-6">
                        ...
                        <form class="form-horizontal" role="form" method="post">
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-5 control-label">Your Product Download
                                    Code</label>

                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="code" id="inputEmail3"
                                           placeholder="Code" value="<?php echo set_value('code'); ?>" autofocus>
                        ...
                        if ($this->session->flashdata('success')) {
                            ...
                            ?>
                            <div class="color0f0"><?php echo $msg; ?>
                            </div>
                        <?php
                        }
                        ?>
            ...
            <div class="modal-body">
                <div class="box-content-modal">
                    <form action="" method="post" id="target" onsubmit="return show(this)">
                        ...
                        <div class="show_error red1a kgt69"></div>
                        <div class="btn-modal toyota-page">
                            <div class="row">
                                ...
                                <div class="col-xs-4 col-md-4 text-center">
                                    <a href="#" id="resend_mail" class="btn btn-primary btn-sm">resend <i
                                            class="glyphicon glyphicon-chevron-right"></i></a>
                                </div>
                                <div class="col-xs-4 col-md-4 text-center">
                                    <a href="#" id="cancel_form" class="btn btn-primary btn-sm">cancel <i
                                            class="glyphicon glyphicon-chevron-right"></i></a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-content-modal">
                    ...
                    <p>Thank you for proving that you are human. Now you can proceed to the screening interview. Good
                        luck!</p>
                    ...
                    <div class="btn-modal">
                        ...
                        <a href="javascript:void(0)" id="ok_bttn"
                           onClick="$('#modal_success').modal('hide')" class="floatright1 btn btn-primary btn-sm">btn-sm"OK <i
                                class="glyphicon glyphicon-chevron-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-body">
                <div class="box-content-modal">
                    ...
                    <div class="btn-modal">
                        ...
                        <a class="" href="javascript:void(0)" id="block_bttn"
                           onClick="$('#modal_block').modal('hide')" class="floatright1 btn btn-primary btn-sm">OK <i
                                class="glyphicon glyphicon-chevron-right"></i></a>
                    </div>
                </div>
            </div>
